...
import static Servicios.InspeccionVehServicios.queryInspeccionFecha;
import static Servicios.InspeccionVehServicios.queryInspeccionPorVehiculo;
...
public class InspeccionRutas {
    ...
    public static void setInspeccionEncRuta() {
        ...
        post("/inspeccionFecha", ((request, response) -> queryInspeccionFecha(JsonUtils.fromJson(request.body()))), JsonUtils::toJson);
     
        post("/inspeccionVehiculo", ((request, response) -> queryInspeccionPorVehiculo(JsonUtils.fromJson(request.body()))), JsonUtils::toJson);
