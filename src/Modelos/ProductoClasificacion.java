...
public class ProductoClasificacion {
    ...
    private String clasificacion_padre;
    ...
    /**
     * @return the clasificacion_padre
     */
    public String getClasificacion_padre() {
        return clasificacion_padre;
    }

    /**
     * @param clasificacion_padre the clasificacion_padre to set
     */
    public void setClasificacion_padre(String clasificacion_padre) {
        this.clasificacion_padre = clasificacion_padre;
    }
